...
$builders = [
    ...
    Curler::class => [CurlerBuilder::class, '--constructor', 'create', '--forward=head,get,post,put,patch,delete,getP,postP,putP,patchP,deleteP,postR,putR,patchR,deleteR', '--desc', '', '--api'],
