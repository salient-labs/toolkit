 ...
 * @method static int listen(string|string[] $event, callable(mixed, string): (false|void) $listener) Register an event listener with the dispatcher (see {@see EventDispatcher::listen()})
