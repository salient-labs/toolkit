 ...
 * @method static mixed coalesce(...$values) Get the first value that is not null (see {@see Conversions::coalesce()})
 ...
 * @method static int|null toIntOrNull($value) Cast a value to an integer, preserving null (see {@see Conversions::toIntOrNull()})
 ...
 * @method static string[] toStrings(...$value) Convert the given strings and Stringables to an array of strings (see {@see Conversions::toStrings()})
