 ...
 * @method static TrashStore close() If a database is open, close it (see {@see TrashStore::close()})
 * @method static TrashStore empty() Delete everything (see {@see TrashStore::empty()})
 * @method static string|null getFilename() Get the filename of the database (see {@see TrashStore::getFilename()})
 * @method static bool isOpen() Check if a database is open (see {@see TrashStore::isOpen()})
