 ...
 * @method static Closure getKeyMapClosure(array<int|string,int|string|array<int,int|string>> $keyMap, int $conformity = ArrayKeyConformity::NONE, int $flags = ArrayMapperFlag::ADD_UNMAPPED) Get a closure to move array values from one set of keys to another (see {@see ArrayMapper::getKeyMapClosure()})
 *
 * @uses ArrayMapper
 *
