 ...
 *
 * @method static Closure getKeyMapClosure(array<int|string,int|string|array<int,int|string>> $keyMap, int $conformity = ArrayKeyConformity::NONE, int $flags = 0) Get a closure to move array values from one set of keys to another
 *
 * @uses ArrayMapper
