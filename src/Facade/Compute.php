 ...
 * @method static string binaryHash(...$value) Generate a unique non-crypto hash and return raw binary data (see {@see Computations::binaryHash()})
 * @method static string hash(...$value) Generate a unique non-crypto hash and return a hexadecimal string (see {@see Computations::hash()})
