 ...
 * @method static string binaryHash(int|float|string|bool|Stringable|null ...$value) Generate a unique non-crypto hash and return raw binary data
 * @method static string hash(int|float|string|bool|Stringable|null ...$value) Generate a unique non-crypto hash and return a hexadecimal string
