 ...
 * @method static bool isArrayOf(mixed $value, string $class, bool $strict = false, bool $allowEmpty = false, bool $requireList = false) Return true for arrays of a class (see {@see Tests::isArrayOf()})
 * @method static bool isArrayOfArray(mixed $value, bool $allowEmpty = false, bool $requireList = false) Return true for array[] (see {@see Tests::isArrayOfArray()})
 * @method static bool isArrayOfIntOrString(mixed $value, bool $allowEmpty = false, bool $requireList = false) Return true for string[] and int[] (see {@see Tests::isArrayOfIntOrString()})
