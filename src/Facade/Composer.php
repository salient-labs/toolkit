 ...
 * @method static \Lkrms\Utility\Composer getInstance() Get the underlying Composer instance
 * @method static bool isLoaded() True if an underlying Composer instance has been loaded
