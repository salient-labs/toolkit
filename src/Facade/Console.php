 ...
 * @method static ConsoleWriter info(string $msg1, ?string $msg2 = null, ?Throwable $ex = null) Print "==> $msg1 $msg2" with level NOTICE
 * @method static ConsoleWriter infoOnce(string $msg1, ?string $msg2 = null, ?Throwable $ex = null) Print "==> $msg1 $msg2" with level NOTICE once per run
 * @method static ConsoleWriter log(string $msg1, ?string $msg2 = null, ?Throwable $ex = null) Print " -> $msg1 $msg2" with level INFO
 * @method static ConsoleWriter logOnce(string $msg1, ?string $msg2 = null, ?Throwable $ex = null) Print " -> $msg1 $msg2" with level INFO once per run
 * @method static ConsoleWriter logProgress(string $msg1, ?string $msg2 = null, ?Throwable $ex = null) Print " -> $msg1 $msg2" with level INFO to TTY targets
