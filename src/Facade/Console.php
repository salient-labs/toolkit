 ...
 * @method static ConsoleWriter out(string $msg, int $level = Level::INFO, bool $formatByLevel = true) Print "$msg" to I/O stream targets (STDOUT or STDERR) (see {@see ConsoleWriter::out()})
 * @method static ConsoleWriter print(string $msg, int $level = Level::INFO, bool $formatByLevel = true) Print "$msg" (see {@see ConsoleWriter::print()})
 ...
 * @method static ConsoleWriter tty(string $msg, int $level = Level::INFO, bool $formatByLevel = true) Print "$msg" to TTY targets (see {@see ConsoleWriter::tty()})
