 ...
 * @method static string[] getClassNamesBetween(string|ReflectionClass $child, string|ReflectionClass $parent, bool $instantiable = false) Return the names of a class and its parents, up to and including $parent (see {@see Reflection::getClassNamesBetween()})
