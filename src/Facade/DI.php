 ...
 * @method static Container bindable(string $id, string[] $services = null, string[] $exceptServices = null) Bind an IBindable and its services, optionally specifying the services to bind or exclude
 ...
 * @method static Container service(string $id, string[] $services = null, string[] $exceptServices = null) Identical to bindable()
