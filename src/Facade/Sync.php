 ...
 * @method static SyncStore deferredRelationship(int $providerId, class-string<ISyncEntity> $entityType, class-string<ISyncEntity> $forEntityType, string $forEntityProperty, int|string $forEntityId, DeferredRelationship<ISyncEntity> $deferred) Register a deferred sync entity relationship
 ...
 * @method static int resolveDeferredRelationships(?int $fromCheckpoint = null, ?int $providerId = null, class-string<ISyncEntity>|null $entityType = null, class-string<ISyncEntity>|null $forEntityType = null, bool|null $offline = null) Resolve deferred sync entity relationships from their respective providers and/or the local entity store (see {@see SyncStore::resolveDeferredRelationships()})
 *
 * @uses SyncStore
 *
