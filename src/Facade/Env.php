 ...
 * @method static string|null get(string $name, string|null $default = null) Get an environment variable (see {@see Environment::get()})
 * @method static bool|null getBool(string $name, bool|null $default = null) Get a boolean value from the environment (see {@see Environment::getBool()})
 * @method static int|null getInt(string $name, int|null $default = null) Get an integer value from the environment (see {@see Environment::getInt()})
