 ...
 * @method static mixed get(string $key, mixed $default = null) Retrieve an item stored under a given key (see {@see CacheStoreInterface::get()})
 * @method static mixed[]|null getArray(string $key, mixed[]|null $default = null) Retrieve an array stored under a given key (see {@see CacheStoreInterface::getArray()})
 * @method static object|null getInstanceOf(string $key, class-string $class, object|null $default = null) Retrieve an instance of a class stored under a given key (see {@see CacheStoreInterface::getInstanceOf()})
 * @method static int|null getInt(string $key, int|null $default = null) Retrieve an integer stored under a given key (see {@see CacheStoreInterface::getInt()})
 ...
 * @method static iterable<string,mixed> getMultiple(iterable<string> $keys, mixed $default = null) Retrieve items stored under the given keys (see {@see CacheStoreInterface::getMultiple()})
 * @method static string|null getString(string $key, string|null $default = null) Retrieve a string stored under a given key (see {@see CacheStoreInterface::getString()})
 * @method static bool has(string $key) Check if an item exists and has not expired (see {@see CacheStoreInterface::has()})
