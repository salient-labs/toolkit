 ...
 * @method static SyncNamespaceHelperInterface|null getNamespaceHelper(class-string<SyncEntityInterface|SyncProviderInterface> $class) Get a namespace helper for a sync entity or provider interface, or null if it is not in a namespace with a registered helper
