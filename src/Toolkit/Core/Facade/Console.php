 ...
 * @method static ConsoleWriterInterface message(Level::* $level, string $msg1, string|null $msg2 = null, ConsoleMessageType::* $type = ConsoleMessageType::STANDARD, Throwable|null $ex = null, bool $count = true) Print "$msg1 $msg2" with prefix and formatting optionally based on $level
 * @method static ConsoleWriterInterface messageOnce(Level::* $level, string $msg1, string|null $msg2 = null, ConsoleMessageType::* $type = ConsoleMessageType::STANDARD, Throwable|null $ex = null, bool $count = true) Print "$msg1 $msg2" with prefix and formatting optionally based on $level once per run
 * @method static ConsoleWriterInterface print(string $msg, Level::* $level = Level::INFO, ConsoleMessageType::* $type = ConsoleMessageType::UNFORMATTED) Print "$msg" to registered targets
 * @method static ConsoleWriterInterface printOut(string $msg, Level::* $level = Level::INFO, ConsoleMessageType::* $type = ConsoleMessageType::UNFORMATTED) Print "$msg" to registered STDOUT or STDERR targets
 * @method static ConsoleWriterInterface printStderr(string $msg, Level::* $level = Level::INFO, ConsoleMessageType::* $type = ConsoleMessageType::UNFORMATTED) Print "$msg" to STDERR even if no STDERR target is registered
 * @method static ConsoleWriterInterface printStdout(string $msg, Level::* $level = Level::INFO, ConsoleMessageType::* $type = ConsoleMessageType::UNFORMATTED) Print "$msg" to STDOUT even if no STDOUT target is registered
 * @method static ConsoleWriterInterface printTty(string $msg, Level::* $level = Level::INFO, ConsoleMessageType::* $type = ConsoleMessageType::UNFORMATTED) Print "$msg" to registered TTY targets
