 ...
 * @method static ConsoleWriter group(string $msg1, string|null $msg2 = null) Create a new message group and print "<<< $msg1 $msg2" with level NOTICE (see {@see ConsoleWriter::group()})
 ...
 * @method static ConsoleWriter message(Level::* $level, string $msg1, string|null $msg2 = null, MessageType::* $type = MessageType::STANDARD, Throwable|null $ex = null, bool $count = true) Print "$msg1 $msg2" with prefix and formatting optionally based on $level (see {@see ConsoleWriter::message()})
 * @method static ConsoleWriter messageOnce(Level::* $level, string $msg1, string|null $msg2 = null, MessageType::* $type = MessageType::STANDARD, Throwable|null $ex = null, bool $count = true) Print "$msg1 $msg2" with prefix and formatting optionally based on $level once per run (see {@see ConsoleWriter::messageOnce()})
 ...
 * @method static ConsoleWriter setTargetPrefix(string|null $prefix, int-mask-of<TargetTypeFlag::*> $flags = 0) Set or unset the prefix applied to each line of output by targets that implement ConsoleTargetPrefixInterface
