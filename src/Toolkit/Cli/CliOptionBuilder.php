 ...
 * @method $this allowedValues(array<string|int|bool|float>|null $value) The option's possible values, indexed by lowercase value if not case-sensitive
 ...
 * @method $this defaultValue(array<string|int|bool|float>|string|int|bool|float|null $value) Assigned to the option if no value is given on the command line
 ...
 * @method $this valueCallback((callable(array<string|int|bool|float>|string|int|bool|float): mixed)|null $value) Applied to the option's value as it is assigned (see {@see CliOption::$ValueCallback})
