...
> The contracts component of the [Salient toolkit][toolkit]
...
`salient/contracts` provides the toolkit's interfaces and abstractions.

## Documentation

[API documentation][api-docs] for `salient/contracts` tracks the `main` branch
of the toolkit's [GitHub repository][toolkit], where further documentation can
also be found.

[api-docs]:
  https://salient-labs.github.io/toolkit/namespace-Salient.Contract.html
