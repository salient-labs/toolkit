...
/**
 * JSON function wrappers that throw an exception on failure
 *
 * @api
 */
final class Json extends AbstractUtility
{
    ...
    /**
     * Convert a JSON string to a value, decoding JSON objects as arrays
     *
     ...
     */
    public static function objectAsArray(string $json, int $flags = 0)
    {
