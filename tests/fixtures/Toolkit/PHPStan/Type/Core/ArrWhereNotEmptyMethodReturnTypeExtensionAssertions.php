...
assertType('*ERROR*', Arr::whereNotEmpty());  // @phpstan-ignore arguments.count, argument.templateType, argument.templateType
assertType('*ERROR*', Arr::whereNotEmpty($a));  // @phpstan-ignore argument.type, argument.templateType, argument.templateType
