...
namespace Salient\Tests\Http\Internal;
...
/**
 * @covers \Salient\Http\Internal\FormDataEncoder
 */
final class FormDataEncoderTest extends TestCase implements HasFormDataFlag
{
    ...
    public function testGetData(): void
    {
        ...
        ], (new FormDataEncoder())->getData(self::getDataObjects()));
    }
    ...
    public function testGetValues(
        ...
        array $data,
        int $flags = self::DATA_PRESERVE_NUMERIC_KEYS | self::DATA_PRESERVE_STRING_KEYS,
        ?DateFormatter $dateFormatter = null,
        ?Closure $callback = null,
        bool $parse = true
    ): void {
        $formData = new FormDataEncoder($flags, $dateFormatter, $callback);
    ...
    /**
     * @return array<array{list<array{string,string|object}>,string,mixed[],3?:int-mask-of<FormDataEncoder::*>,4?:DateFormatter|null,5?:Closure|null,6?:bool}>
     */
    public static function formDataProvider(): array
    {
        ...
        return [
            ...
            [
                ...
                $data,
                self::DATA_PRESERVE_NUMERIC_KEYS | self::DATA_PRESERVE_STRING_KEYS,
            ...
            [
                ...
                $lists,
                self::DATA_PRESERVE_STRING_KEYS,
                null,
                null,
                false,
            ],
            [
                ...
                $lists,
                self::DATA_PRESERVE_LIST_KEYS | self::DATA_PRESERVE_NUMERIC_KEYS,
                null,
                null,
                false,
            ],
