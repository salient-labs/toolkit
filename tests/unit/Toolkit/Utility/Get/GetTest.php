...
namespace Salient\Tests\Utility\Get;
...
[
    ...
    'classes' => [
        Salient\Tests\Utility\Get\GetTest::class,
        GetTest::class,
        'gettest',
    ],
...
EOF,
    ...
    public function testCopy(): void
    {
        ...
        $j = new ClassWithValue('J');
        $k = Get::copy(
            $j,
            fn($obj) => $obj instanceof ClassWithValue ? new ClassWithValue($obj->Value) : false,
        );
