...
final class FormatTest extends \Salient\Tests\TestCase
{
     ...
     */
    public function testArray(string $expected, ?array $array, string $format = "%s: %s\n", int $indent = 4): void
    {
    ...
    public static function arrayProvider(): array
    {
        return [
            ...
            [
                ...
                [0, -2.1, 'true' => true, 'false' => false, 'empty' => '', 'null' => null, 'split' => "two\nlines", [], [3], ['foo' => null]],
            ],
            [
                implode("\n", [
                    '1. a',
     ...
     */
    public function testBytes(string $expected, ?int $bytes, int $precision = 3, bool $binary = true): void
    {
