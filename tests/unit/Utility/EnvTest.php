...
final class EnvTest extends \Lkrms\Tests\TestCase
{
    ...
    public static function getProvider(): array
    {
        return [
            ...
            'whitespace -> bool, with default' => [null, 'getBool', ['value' => ' ', 'default' => true], InvalidEnvironmentException::class],
    ...
    public static function getNullableProvider(): array
    {
        return [
            ...
            '[nullable] whitespace -> int, with default' => [null, 'getNullableInt', ['value' => ' ', 'default' => 1], InvalidEnvironmentException::class],
            ...
            "[nullable] 'f' -> bool" => [false, 'getNullableBool', ['value' => 'f']],
            "[nullable] 'false' -> bool" => [false, 'getNullableBool', ['value' => 'false']],
            "[nullable] 't' -> bool" => [true, 'getNullableBool', ['value' => 't']],
            ...
            '[nullable] whitespace -> bool, with default' => [null, 'getNullableBool', ['value' => ' ', 'default' => true], InvalidEnvironmentException::class],
