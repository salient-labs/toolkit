...
final class SyncEntityResolverTest extends \Lkrms\Tests\TestCase
{
    public function testGetByName(): void
    {
        ...
        $resolvers = [
            ...
            'Levenshtein' => new SyncEntityFuzzyResolver($userEntityProvider, 'Name', null, TextSimilarityAlgorithm::LEVENSHTEIN, 0.6),
            'similar text' => new SyncEntityFuzzyResolver($userEntityProvider, 'Name', null, TextSimilarityAlgorithm::SIMILAR_TEXT, 0.6),
        ];
