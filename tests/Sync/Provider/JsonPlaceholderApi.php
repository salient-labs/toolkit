...
class JsonPlaceholderApi extends HttpSyncProvider implements PostProvider, UserProvider
{
    ...
    {
        return Post::fromArray($this->getCurler("/posts/" . $id)->getJson());
    }
    ...
    {
        return Post::listFromArrays($this->getCurler("/posts")->getJson());
    }
    ...
    {
        return User::fromArray($this->getCurler("/users/" . $id)->getJson());
    }
